...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    company: 'NIDDIKKARE LLP',
    experience: '15+ Years',
    shortBio: 'Dr. Abhishek Chanchal is a highly accomplished researcher with over 15 years of experience in Chemical Biology, Nanotechnology, Analytical Instrumentation and IVD-Medical Devices. He has actively contributed to numerous research projects and peer-reviewed international publications. His work is dedicated to harnessing the potential of nanotechnology and chemical biology to forge innovative solutions for earlier disease diagnosis and improve therapeutic effectiveness. He focuses on creating Targeted Nano-therapeutics and Point-of-Care Testing (POCT) based IVD medical devices, which carry profound implications for global healthcare, particularly in resource-constrained environments. During the COVID-19 pandemic, his nano & microparticle-based DNA/RNA extraction systems were instrumental in rapid detection and differentiation of SARS-CoV-2 variants.',
